...
class LoremB(InvoiceComponent):
    ...
    def render(textRenderer:TextRenderer, data:InvoiceData, invoice:Invoice, x: int, y: int, **kwargs):
        ...
        textRenderer._text(invoice, d, (x + mm(2), y + box_h + mm(1)), text="Razítko a podpis", font=textRenderer._f8, fill=MUTED)
        ...
        textRenderer._text(invoice, d, (stamp_x + mm(4), y + mm(8)), text="SCHVÁLENO", font=textRenderer._f8b, fill=(180, 40, 40))
