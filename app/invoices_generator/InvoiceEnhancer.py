...
from invoices_generator.utility.invoice_consts import banks_, payments
    ...
    def enhance(layoutlmv3_path:str, instances_per_invoice=1)->None:
        ...
        for line in tqdm(lines):
            ...
            for _ in range(instances_per_invoice):
                ...
                items, total_price, total_vat = InvoiceGenerator.generate_items(items_quantity)
                ...
                invoice_data = InvoiceData(invoice_number=invoice_number,
                    ...
                    supplier=supp, customer=cust, total_price=total_price,
                    bank_account=bank, payment_type=payment, items=items)
                ...
                invoice_renderer.enhandce(invoice_data, invoice)
