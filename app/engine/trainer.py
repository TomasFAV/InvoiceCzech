...
class trainer:
    ...
    def train()->tuple[Any, Any]:
        ...
        train_dataset = invoice_dataset(data_root_folder_path="app/data/train", processor=processor, model=model,max_length=max_length, task_start_token="<s_cord-v2>", prompt_end_token="<s_cord-v2>")

        test_dataset = invoice_dataset(data_root_folder_path="app/data/test", processor=processor, model=model,max_length=max_length, task_start_token="<s_cord-v2>", prompt_end_token="<s_cord-v2>")

        val_dataset = invoice_dataset(data_root_folder_path="app/data/validation", processor=processor, model=model,max_length=max_length, task_start_token="<s_cord-v2>", prompt_end_token="<s_cord-v2>")
